...
class App(customtkinter.CTk):
    ...
    def btn_mostrar_on_click(self):
        ...
        altura_pivot = float(altura)

        if altura_pivot > 1.80:
            alert(title = "Altura para ser Pivot", message = "Usted pude ser pivot")
        else:
            alert(title = "Altura para ser Pivot", message = "Usted no pude ser pivot")
